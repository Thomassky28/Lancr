...
sp1 = ServiceProvider.create(
  ...
  img: Rails.root.join('public/uploads/boy.jpg').open,
...
sp2 = ServiceProvider.create(
  ...
  password_digest: BCrypt::Password.create('asdf'),
  img: Rails.root.join('public/uploads/girl.jpg').open,
...
sp3 = ServiceProvider.create(
  ...
  email: Faker::Internet.free_email,
  password_digest: BCrypt::Password.create('asdf'),
  img: Rails.root.join('public/uploads/girl2.jpg').open,
...
service0 = Service.create(
  ...
  img: Rails.root.join('public/uploads/accounting-service.jpg').open,
  is_booked: false
)
...
service1 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/beauty-salon-service.jpg').open,
  is_booked: true
)
...
service2 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/car-detailing-service.jpg').open,
  is_booked: false
)
...
service3 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/cleaning-service.jpg').open,
  is_booked: false
)
...
service4 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/dog-walker-service.jpg').open,
  is_booked: false
)
...
service5 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/grooming-service.jpg').open,
  is_booked: false
)
...
service7 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/landscaping-service.jpg').open,
  is_booked: false
)
...
service8 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/massage-service.jpg').open,
  is_booked: false
)
...
service9 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/marketing-service.png').open,
  is_booked: false
)
...
service10 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/pc-service.jpg').open,
  is_booked: false
)
...
service11 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/photography-service.jpg').open,
  is_booked: true
)
...
service12 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/translation-service.png').open,
  is_booked: false
)
...
service13 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/tutoring-service.jpg').open,
  is_booked: false
)
...
service15 = Service.create(
  ...
  end_time: Faker::Time.forward(20, :day),
  price: Faker::Commerce.price,
  img: Rails.root.join('public/uploads/makeup-service.jpg').open,
  is_booked: false
)
